...
describe('Testes de integração', () => {
    ...
    describe('GET em /api/products/:idProduct', () => {
        it('Deve retornar um produto específica', async () => {
            const response = await request(app).get(`/api/products/${idProduct}`);
            expect(response.status).toBe(200);
        });
        it('Deve retornar um erro, caso o idProduct não exista', async () => {
    ...
    describe('PUT em /api/admin/products/update/:idProduct', () => {
        ...
        it('Deve retornar um erro caso o idProduct não seja encontrado', async () => {
            const mockProduto = {
                nome: 'Smartphone Samsung Galaxy S23 Plus',
                descricao: 'Smartphone Samsung Galaxy S23 Plus 256GB creme 5G 8GB RAM',
                estoque: 164,
        ...
        it('Deve retornar um erro se o nome atualizado não tiver um formato valido', async () => {
            const response = await request(app)
                .put(`/api/admin/products/update/${idProduct}`)
                .send({ nome: 'Sm' });
        ...
        it('Deve retornar um erro se o slug atualizado não tiver um formato valido', async () => {
            const response = await request(app)
                .put(`/api/admin/products/update/${idProduct}`)
        ...
        it('Deve retornar um erro se o preço atualizado for menor ou igual a zero', async () => {
            const response = await request(app)
                .put(`/api/admin/products/update/${idProduct}`)
                .send({ preco: 0 });
        ...
        it('Deve retornar um erro se o estoque atualizado não estiver entre 0 e 9999', async () => {
            const response = await request(app)
                .put(`/api/admin/products/update/${idProduct}`)
                .send({ preco: 16000 });
        ...
        it('Deve retornar um erro se a categoria atualizada não for encontrada', async () => {
            const response = await request(app)
                .put(`/api/admin/products/update/${idProduct}`)
                .send({ categoria: '123' });
